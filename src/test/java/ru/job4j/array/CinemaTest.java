...
public class CinemaTest {
    ...
    @Test
    public void checkEmptyPlace1() {
        Cinema.Place[][] places = {
                {new Cinema.Place(0, 0), null, new Cinema.Place(0, 2), null, new Cinema.Place(0, 4)},
                ...
                {new Cinema.Place(4, 0), new Cinema.Place(4, 1), new Cinema.Place(4, 2), null, null}
        };
        Cinema.Place rsl = Cinema.checkEmptyPlace(places);
    ...
    public void checkEmptyPlace2() {
        Cinema.Place[][] places = {
                {new Cinema.Place(0, 0), null, new Cinema.Place(0, 2), null, new Cinema.Place(0, 4)},
                {null, new Cinema.Place(1, 1), null, new Cinema.Place(1, 3), null},
                {new Cinema.Place(2, 0), null, new Cinema.Place(2, 2), null, new Cinema.Place(2, 4)},
                {null, new Cinema.Place(3, 1), null, new Cinema.Place(3, 3), null},
                {new Cinema.Place(4, 0), new Cinema.Place(4, 1), new Cinema.Place(4, 2), null, new Cinema.Place(4, 4)}
        };
        Cinema.Place rsl = Cinema.checkEmptyPlace(places);
